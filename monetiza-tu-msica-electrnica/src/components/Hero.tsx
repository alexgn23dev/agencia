      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 lg:pt-36 lg:pb-28 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="animate-fade-in-up delay-200 text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
            Transformamos productores de electrónica con talento real en negocios que facturan
            <span className="text-text-primary font-medium"> +2.000€/mes desde su home studio</span>.
            Sin bolos. Sin esperar que el algoritmo te descubra. Sin vender beats a 20€.
          </p>
          ...
          <p className="animate-fade-in-up delay-400 text-sm text-text-muted">
            Gratuita · 30 minutos · Solo aceptamos productores con nivel técnico demostrado
          </p>
          ...
          <div className="animate-fade-in-up delay-500 mt-16 pt-8 border-t border-border-subtle">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12">
              <div className="text-center">
                ...
                <p className="text-sm text-text-muted">Productores facturando</p>
              </div>
              <div className="hidden sm:block w-px h-10 bg-border-subtle" />
              <div className="text-center">
                <p className="text-2xl font-bold text-text-primary">8 semanas</p>
                <p className="text-sm text-text-muted">Hasta los primeros clientes</p>
              </div>
              <div className="hidden sm:block w-px h-10 bg-border-subtle" />
              <div className="text-center">
                <p className="text-2xl font-bold text-text-primary">93%</p>
                <p className="text-sm text-text-muted">Consiguen clientes en el programa</p>
              </div>
            </div>
          </div>
        </div>

    ...
    <section id="reservar" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
          Tu música ya suena bien.
          <br />
          <span className="gradient-text">Es hora de que tu negocio también.</span>
        </h2>

        <p className="text-lg sm:text-xl text-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
          No necesitas más plugins. No necesitas más seguidores. 
          Necesitas un sistema que convierta tu talento en ingresos.{' '}
          <span className="text-text-primary font-medium">Empieza con una conversación.</span>
        </p>
        ...
        <div className="mt-20 pt-12 border-t border-border-subtle">
          ...
          <div className="space-y-3">
            <p className="text-xl sm:text-2xl font-bold text-text-secondary/60">
              "Tu música suena profesional. Tu cuenta bancaria, no."
            </p>
            ...
            <p className="text-xl sm:text-2xl font-bold text-text-secondary/20">
              "Produces como un pro. Cobras como un amateur."
            </p>
          </div>
        </div>
      </div>
